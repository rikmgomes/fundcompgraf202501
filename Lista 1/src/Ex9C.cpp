	...
	while (!glfwWindowShouldClose(window))
	{
		// Este trecho de código é totalmente opcional: calcula e mostra a contagem do FPS na barra de título
		{
			...
			if (title_countdown_s <= 0.0 && elapsed_s > 0.0)
			{
				...
				char tmp[256];
				sprintf(tmp, "Ex 9 -- Triângulo Vermelho, Verde e Azul -- Ricardo Moreira Gomes\tFPS %.2lf", fps);
...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
		...
		// T1
		-0.65, 0.33, 0.0, 1.0, 1.0, 0.0,
		-0.27, 0.53, 0.0, 0.0, 1.0, 1.0,
		-0.61, 0.79, 0.0, 1.0, 0.0, 1.0
	};
	...
	//Ponteiro pro atributo 0 - Posição - coordenadas x, y, r z
